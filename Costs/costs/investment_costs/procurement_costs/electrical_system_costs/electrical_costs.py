...
from input_params import transmission_voltage, grid_coupling_point_voltage, V_rated_voltage, rv, distance_to_grid, rho_copper, rho_xlpe, epsilon_0, epsilon_r, frequency
