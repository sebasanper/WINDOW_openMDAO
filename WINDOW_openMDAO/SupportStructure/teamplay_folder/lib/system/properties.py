from WINDOW_openMDAO.input_params import solidity_rotor, cd_rotor_idle_vane, cd_nacelle, \
    mass, yaw_diameter, wind_speed_at_max_thrust, max_thrust, \
    front_area_nacelle, yaw_to_hub_height, mass_eccentricity#, generator_voltage, warranty_percentage
...
class RNA:
    ...
    def __init__(self, rotor_radius):
        ...
        self.max_thrust = max_thrust  # [N] Maximum thrust determined from thrust coefficient curve multiplied with 1.5 amplification factor (determined by Otto for NREL 5 MW turbine)
        ...
        self.mass = mass  # [kg] 79 tonne nacelle + 3x 6.5 tonne blades
        ...
        self.wind_speed_at_max_thrust = wind_speed_at_max_thrust  # [m/s] Horns rev website: 13 m/s - Vestas V80 brochure: 16 m/s, but max thrust appears at 12 m/s
