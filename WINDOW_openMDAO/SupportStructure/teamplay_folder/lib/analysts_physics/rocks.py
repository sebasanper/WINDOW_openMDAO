...
class RockAnalysts(object):
    ...
    def get_characteristic_friction(self, d50, current, amplitude_bottom_velocity, wave_period, wave_current_angle):
        ...
        mean_friction = current_friction * (1.0 + 1.2 * (old_div(wave_friction, (current_friction + wave_friction)))**3.2)
    ...
    def get_wave_friction(self, d50, amplitude_bottom_velocity, wave_period):
        amplitude_bottom_motion = old_div((amplitude_bottom_velocity * wave_period), (2.0 * pi))
        r_w = amplitude_bottom_velocity * amplitude_bottom_motion / self.nu_water
        r = old_div(amplitude_bottom_motion, (2.5 * d50))
    ...
    def f_w_factor(self, d, *args):
        ...
        return (old_div(lefthand_side, righthand_side)) - 1.0

    def get_current_friction(self, d50, current):
        z_0 = 2.5 * d50 / 30.0
        c_d = (old_div(0.40, (1.0 + log(old_div(z_0, self.support_team.physical_environment.site.water_depth))))) ** 2.0
