...
class WorkingGroup(Group):
    ...
    def setup(self):
        ...
        indep2.add_output('n_turbines', val=61)
        indep2.add_output('n_turbines_p_cable_type', val=[1, 3, 4])
        indep2.add_output('substation_coords', val=[[497362.0, 5730299.0], [496845.0, 5731342.0]])
        indep2.add_output('n_substations', val=2)
