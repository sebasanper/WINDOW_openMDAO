...
setup(
    ...
    packages=[
      ...
      'WINDOW_openMDAO.src.AbsAEP.FastAEP',
      'WINDOW_openMDAO.src.AbsAEP.FastAEP.farm_energy',
      'WINDOW_openMDAO.src.AbsAEP.FastAEP.farm_energy.wake_model_mean_new',
      'WINDOW_openMDAO.src.AbsAEP.FastAEP.farm_energy.wake_model_mean_new.aero_power_ct_models',
      'WINDOW_openMDAO.src.AbsAEP.FastAEP.site_conditions',
      'WINDOW_openMDAO.src.AbsAEP.FastAEP.site_conditions.wind_conditions',
